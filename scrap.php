...
<body>
<div class="mt-5">
  <center><h1 class="mb-3 text-primary"  style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;"><u>SCRAP LIST - ACCESSION ENTRIES</u></h1></center>
...
<div class="mt-5">
  <center><h1 class="mb-3 text-primary" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;"><u>SCRAP LIST - DEPARTMENTS</u></h1></center>
<table class="table table-hover table-striped table-bordered">
